        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">PLANNER VACANZE </h1>
                <p className="text-sm text-gray-600">{"MRT3"}</p>
              </div>
            </div>
      ...
      <div className="min-h-screen flex items-center justify-center px-6 pt-24 pb-12">
        <div className="w-full max-w-lg">
          ...
          <Card className="bg-white shadow-2xl border border-gray-100 rounded-2xl overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-gray-50 to-blue-50 px-8 py-8 border-b border-gray-100">
              <div className="text-center">
                ...
                <CardTitle className="text-2xl font-bold text-gray-900 mb-2">Accesso Sicuro</CardTitle>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-12 border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 rounded-lg text-base bg-white transition-all duration-200"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="h-12 border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 rounded-lg text-base bg-white pr-12 transition-all duration-200"
